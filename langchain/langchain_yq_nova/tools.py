...
def create_remember_tool(client: Client, name: str = "nova_remember") -> StructuredTool:
...
def create_forget_tool(client: Client, name: str = "nova_forget") -> StructuredTool:
...
def create_memory_tools(client: Client) -> List[StructuredTool]:
    return [
